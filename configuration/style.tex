...
\iftoggle{sectionmargin}{%
    \titleformat{\section}% Command
        {\LARGE}% Format
        {\hspace{-3cm}\makebox[3cm][r]{\color{colorblack}\thesection\hspace{0.5cm}}}% Label
        {0em}% Sep
...
\iftoggle{sectionmargin}{%
    \titleformat{\subsection}[block]%
        {\Large}%
        {\hspace{-3cm}\makebox[3cm][r]{\color{colorblack}\thesubsection\hspace{0.5cm}}}% Label
        {0em}%
        {\raggedright}%
        [\phantomsection]
}{%
...
\iftoggle{sectionmargin}{%
    \titleformat{\subsubsection}% Command
        [hang]% Shape
        {\large}% Format
        {\hspace{-3cm}\makebox[3cm][r]{\color{colorblack}\thesubsubsection\hspace{0.5cm}}}% Label
        {0em}% Sep
        {\raggedright}% Before Code
        [\phantomsection]% After Code
}{%
