...
%     {% TODO: faire un titre un peu plus jolie
%         \rule{\textwidth}{1pt}
...
\titleformat%
    ...
    {%
        ...
        \raggedleft{%
            ...
            \hspace{0.5em}%
            {\def\stackalignment{l}\stackon[18pt]{\color{colorcentrale}\fontsize{60}{60}\selectfont\thechapter}{\normalsize{\textsc{\@chapapp}}}}
        }\hspace{-1em}%
    }% Label
    {-3.1em}% Sep
...
\newcommand{\unumeredchaptermark}[1]{
	\markboth{\footnotesize{\color{colorcentrale}\textsc{#1}}}{}%
}
