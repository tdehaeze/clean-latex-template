...
\newcommand{\rapportSubject}{Sujet du rapport}
...
\usepackage[                    % setup the hyperref-package options
    pdftitle={\rapportTitle},   % title (PDF meta)
    pdfsubject={\rapportSubject},% subject (PDF meta)
    pdfauthor={\rapportAuthor}, % author (PDF meta)
    plainpages=false,           %
